...
class Splatnet(commands.Cog):
    ...
    async def s2(self, ctx):
        ...
        async with ctx.typing():
            ...
            turf_time_left = datetime.fromtimestamp(schedule["regular"][0]["end_time"]) - datetime.fromtimestamp(schedule["regular"][0]["start_time"])
            ...
            turf_embed.add_field(name="Map Set:", value=f"{turf_map_1}, {turf_map_2}")
            ...
            ranked_embed.add_field(name="Current Mode:", value=ranked_mode)
            ranked_embed.add_field(name="Map Set:", value=f"{ranked_map_1}, {ranked_map_2}")
            ...
            league_embed.add_field(name="Current Mode:", value=f"{league_mode}")
            league_embed.add_field(name="Map Set:", value=f"{league_map_1}, {league_map_2}")
            ...
            salmon_embed.add_field(name="Current Recruitment Drive Time Window:", value=f"From {grizzco_start}, to {grizzco_end}")
            salmon_embed.add_field(name="Current Location:", value=f"{grizzco_map}")
            salmon_embed.add_field(name="Available Weapon Pool:", value=f"{grizzco_wep_1}, {grizzco_wep_2}, {grizzco_wep_3}, and {grizzco_wep_4}")
